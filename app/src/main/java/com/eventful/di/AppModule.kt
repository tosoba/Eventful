...
abstract class AppModule {
    @Binds abstract fun applicationContext(application: EventfulApp): Context

    @Binds abstract fun eventAlarmManager(manager: EventAlarmManager): IEventAlarmManager

    companion object {
        @Provides @Singleton fun rxLocation(context: Context): RxLocation = RxLocation(context)

        @Provides
        @Singleton
        fun flickr(): Flickr =
            Flickr("788264798ee17aeec322c9930934dcd9", "08cd341dd13fba62", REST())
