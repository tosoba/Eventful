...
internal class SearchSuggestionsAdapter(context: Context, cursor: Cursor?) :
    CursorAdapter(context, cursor, false) {

    override fun newView(context: Context, cursor: Cursor?, parent: ViewGroup): View? =
        cursor?.let {
            LayoutInflater.from(context).inflate(R.layout.search_suggestion, parent, false).apply {
